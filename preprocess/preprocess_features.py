...
def features_files(features_dir):
    return {
        'train': [os.path.join(features_dir, f'karpathy_train_xception_faster_rcnn_genome.tsv.0'),
                  os.path.join(features_dir, f'karpathy_train_xception_faster_rcnn_genome.tsv.1')],
        'valid': [os.path.join(features_dir, f'karpathy_val_xception_faster_rcnn_genome.tsv')],
        'test': [os.path.join(features_dir, f'karpathy_test_xception_faster_rcnn_genome.tsv')]
    }
